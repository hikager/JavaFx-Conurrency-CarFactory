 ...
 * @author Luis ML
 */
public class StampingBuilder implements CarPieceFactory {
     ...
     */
    public StampingBuilder(int MAX_STOCK, int MIN_STOCK, int PROD_PER_HOUR) throws Exception {
    ...
    public synchronized void produce(int count) throws InterruptedException {
        if (canProduce()) {
            ...
            System.out.println("PRODUCIENDO ESTAMPACIONES\n");
        } else {
            System.out.println("STOP PRODUCIENDO ESTAMPACIONES\n");
        }
